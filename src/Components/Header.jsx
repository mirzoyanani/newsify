...
const Header = () => {
  return (
    <div className="header">
      <NavLink className="shortcuts-list-item"  to='/'><p className="title"> Newsify</p></NavLink>
      <div className="navbar">
        <ul className="shortcuts-list">
          ...
          <li className="shortcuts-list-item"><NavLink className="shortcuts-list-item navlink"  to='/saved'>Saved</NavLink></li>
        </ul>
      </div>
      <div>
        <form id="content">
